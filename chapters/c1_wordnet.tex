...
- Hierarchie (Vertikal) is-a-relations Hypernym (nltk quelle), keine pos grenzenübertretung
- nur verben und noben haben hierarchien
- nicht domain spezifisch
- am meisten für WSD eingesetzt
...
nltk quelle:
- WSD, info retrieval, text classification, text summarization, machine translation cross word puzzzle generation, distanz zwischen worten ermitteln

Distanz messen 4 Methoden:
path-based: schritte
information content based: shared info content
feature-based: zahl der gleichen charakteristika
hybride: combination
