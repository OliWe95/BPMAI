...
\label{fig:ENHDEPS}
\end{wrapfigure}
Der Stanford Parser baut auf den POS-Tags auf und liefert eine nochmals erweiterte syntaktische Analyse des Textes. Es werden zusätzlich die Abhängigkeiten zwischen den einzelnen Worten im Satz ermittelt. Abbildung \ref{fig:ENHDEPS} zeigt die Anhängigkeiten innerhalb der beiden Beispielsätze. (...Hier fehlt noch was)
